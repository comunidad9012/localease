...
class Pedidos extends Controllers{
	...
	public function Pedidos()
	{
		...
		$data['page_title'] = "PEDIDOS <small>LocalEase</small>";
	...
	public function orden($idpedido){
		...
		$data['page_tag'] = "Pedido - LocalEase";
		$data['page_title'] = "PEDIDO <small>LocalEase</small>";
	...
	public function transaccion($transaccion){
		...
		$data['page_tag'] = "Detalles de la transacción - LocalEase";
